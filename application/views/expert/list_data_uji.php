...
<head>
  ...
  <title>BI Rate Forecasting | Data Uji</title>
...
<div class="wrapper">
          ...
          <ul class="active treeview-menu">
            <li>
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="<?php echo base_url('expert/list-data-training'); ?>"><i class="fa fa-list-ul"></i> List Data Latih</a></li>
              </ul>
            </li>
            <li>
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="#"><i class="fa fa-list-ul"></i> List Data Uji</a></li>
              </ul>
            </li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Dashboard
        <small>List Data Uji</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url('admin/home')?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="fa fa-users active"> List Data Uji</li>
      </ol>
    </section>
              ...
              <?php
                ...
                foreach($data_uji as $row)
                {
                  ...
                  echo '<td> <div class="btn-group">
                    <a href="edit-data/'.$row->uuid_fp_data_uji.'" role="button" class="btn btn-primary btn-flat"><i class="fa fa-edit"></i></a>';
                  echo '<a href="delete-data/'.$row->uuid_fp_data_uji.'" role="button" class="btn btn-danger btn-flat"><i class="fa fa-user-times"></i></a>';
                  echo '</div> </td>';
                  echo '</tr>';
                  $a++;
                }
