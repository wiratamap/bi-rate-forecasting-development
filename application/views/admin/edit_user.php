...
<head>
  ...
  <title>BI Rate Forecasting | Edit User</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="fa fa-users active"> Edit User</li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="col-md-12">
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <?php echo form_open('admin/update-user'); ?>
            <div class="box-body">
              <div class="form-group has-feedback">
                <label>Username</label>
                <input type="text" class="form-control" value="<?php echo $user->username ?>" placeholder="Username" name="username" required>
              </div>
                <span class="text-danger"><?php echo form_error('username'); ?></span>
              <div class="form-group has-feedback">
                <label>Full Name</label>
                <input type="text" class="form-control" value="<?php echo $user->full_name; ?>" placeholder="Full name" name="full_name" required>
              </div>
                <span class="text-danger"><?php echo form_error('full_name'); ?></span>
              <div class="form-group has-feedback">
                <label>Email</label>
                <input type="email" class="form-control" value="<?php echo $user->email; ?>" placeholder="Email" name="email" required>
              </div>
