...
<head>
  ...
  <title>BI Rate Forecasting | User List</title>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="#"><i class="fa fa-user"></i> List User</a></li>
          </ul>
        </li>
    </section>
    <!-- /.sidebar -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="fa fa-users active"> List User</li>
      </ol>
    </section>
            ...
            <tbody>
              <?php
                foreach($data_user as $row)
                {
                  ...
                  echo '<td>'.$row->subsystem_value.'</td>';
                  if($row->is_active == "1") {
                  ...
                  if($row->is_logged_in == "1") {
                    echo '<td><span class="fa fa-circle text-success"></span></td>';
                  } else {
                    echo '<td><span class="fa fa-circle text-danger"></span></td>';
                  }
                  echo '<td> <div class="btn-group">
                    <a href="edit-user/'.$row->uuid_ms_user.'" role="button" class="btn btn-primary btn-flat"><i class="fa fa-edit"></i></a>';
                  if($row->username != $this->session->userdata('username')) {
                    echo '<a href="delete-user/'.$row->uuid_ms_user.'" role="button" class="btn btn-danger btn-flat"><i class="fa fa-user-times"></i></a>';
                  } else {
                    echo '<button type="button" class="btn btn-danger btn-flat" disabled><i class="fa fa-user-times"></i></button>';
                  }
