  ...
  public function list_data_training() {
	...
	public function compose_mail() {
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$this->load->view('expert/compose_mail', array('all_user' => $data['all_user']));
		} else {
			$data = array(
